...
int main(int argc, char* argv[]) {
  if(argc != 6){ printf("Error: too few params\n");return -1;
  }
  // INPUT PARAMETERS:
  //
  ...
  objPts[1].x = grid_width*(board_w-1);  objPts[1].y = 0;
  objPts[2].x = 0;          objPts[2].y = grid_width*(board_h-1);
  objPts[3].x = grid_width*(board_w-1);  objPts[3].y = grid_width*(board_h-1);
  imgPts[0]   = corners[0];
